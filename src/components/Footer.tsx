...
const socialLinks = [
  {
    name: 'Twitter',
    href: 'https://x.com/OcularAI_COIN_',
    icon: (
...
export default function Footer() {
  return (
    <footer className="relative w-full border-t border-gray-700/50 py-12">
      {/* Background gradient */}
      <div className="absolute inset-0 bg-gradient-to-t from-black/20 to-transparent" />
      
      {/* Grid pattern overlay */}
      <div className="absolute inset-0 bg-[linear-gradient(rgba(125,211,252,0.03)_1px,transparent_1px),linear-gradient(90deg,rgba(125,211,252,0.03)_1px,transparent_1px)] bg-[size:2rem_2rem] [mask-image:radial-gradient(ellipse_50%_80%_at_50%_100%,#000_70%,transparent_100%)]" />
      ...
      <div className="container max-w-8xl mx-auto px-6 lg:px-8 relative">
        <div className="flex flex-col md:flex-row items-center justify-between gap-8">
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="relative">
              <div className="w-12 h-12">
                <Image src="/favicon.png" alt="OcularAI" className="w-12 h-12" width={48} height={48} />
              </div>
              {/* Corner accents */}
              <div className="absolute -top-1 -right-1 w-3 h-3 border-t-2 border-r-2 border-sky-300" />
              <div className="absolute -top-1 -left-1 w-3 h-3 border-t-2 border-l-2 border-sky-300" />
              <div className="absolute -bottom-1 -right-1 w-3 h-3 border-b-2 border-r-2 border-sky-300" />
              <div className="absolute -bottom-1 -left-1 w-3 h-3 border-b-2 border-l-2 border-sky-300" />
            </div>
          ...
          <div className="flex flex-col md:flex-row items-center gap-6 text-gray-400">
            ...
            <div className="text-center md:text-right">
              <p className="text-sm font-mono uppercase tracking-tight mb-1">
                © 2025 OcularAI
              </p>
            ...
            {/* Decorative element */}
            <div className="hidden md:block w-px h-8 bg-gradient-to-b from-transparent via-sky-300/30 to-transparent" />
                ...
                if (hasLink) {
                  return (
                    <a
                      ...
                      className="text-gray-500 hover:text-sky-300 transition-colors duration-200 cursor-pointer"
                      data-cursor-style="social-button"
                  ...
                  return (
                    <span
                      key={social.name}
                      className="text-gray-600/50 cursor-default"
        ...
        {/* Bottom border with HUD styling */}
        <div className="mt-8 pt-6 border-t border-gray-700/30 flex justify-center">
          <div className="flex items-center gap-2 text-xs text-gray-500 font-mono uppercase tracking-wide">
            <div className="w-2 h-2 bg-sky-300/50" />
            <span>Decentralized AI-powered smart glasses</span>
            <div className="w-2 h-2 bg-sky-300/50" />
          </div>
        </div>
      </div>
